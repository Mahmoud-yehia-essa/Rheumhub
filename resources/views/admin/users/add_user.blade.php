...
<div class="page-content">
    ...
    <div class="container">
		...
		<form method="post" action="{{ route('admin.add.user.store') }}" enctype="multipart/form-data" >
			@csrf
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <select class="form-select mb-3" name="job_title" aria-label="Default select example" required value="{{old('job_title')}}">
                                        ...
                                        <option value="{{$jobTitle->id}}">{{$jobTitle->name}} - {{$jobTitle->ar_name}} </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <select class="form-select mb-3" name="job_place" aria-label="Default select example" required value="{{old('job_place')}}">
                                        {{-- <option selected="" value="">Select Membership type</option>
                                        <option value="permanent">Permanent / Kuwaiti</option>
                                        <option value="associate">Associate / Non-Kuwaiti</option>
                                        <option value="affiliate">Affiliate / (Kuwaiti - Non-Kuwaiti)</option> --}}
                                        ...
                                        <option value="{{$jobPlace->id}}">{{$jobPlace->name}} - {{$jobPlace->ar_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control"   name="kma_no" value="{{old('kma_no')}}"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <input type="date" class="form-control"  name="kma_valid"  value="{{old('kma_valid')}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <select class="form-select mb-3" name="membership" aria-label="Default select example" required value="{{old('membership')}}">
                                        {{-- <option selected="" value="">Select Membership type</option>
                                        <option value="permanent">Permanent / Kuwaiti</option>
                                        <option value="associate">Associate / Non-Kuwaiti</option>
                                        <option value="affiliate">Affiliate / (Kuwaiti - Non-Kuwaiti)</option> --}}
