...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Send Notification for memberships</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Send Notification for memberships</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="container">
		...
		<form method="post" action="{{ route('admin.add.notification.memberships.store') }}" enctype="multipart/form-data" >
			@csrf
                <div class="col-lg-16">
                    <div class="card">
                        <div class="card-body">
